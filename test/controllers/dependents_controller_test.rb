...
class DependentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dependent" do
    assert_difference("Dependent.count") do
      post dependents_url, params: { dependent: { date_of_birth: @dependent.date_of_birth, insured_id: @dependent.insured_id, name: @dependent.name, relationship: @dependent.relationship } }
    end
  ...
  test "should update dependent" do
    patch dependent_url(@dependent), params: { dependent: { date_of_birth: @dependent.date_of_birth, insured_id: @dependent.insured_id, name: @dependent.name, relationship: @dependent.relationship } }
