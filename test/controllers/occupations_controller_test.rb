...
class OccupationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occupation" do
    assert_difference("Occupation.count") do
      post occupations_url, params: { occupation: { business_type: @occupation.business_type, employer_address: @occupation.employer_address, employer_name: @occupation.employer_name, insured_id: @occupation.insured_id, name: @occupation.name } }
    end
  ...
  test "should update occupation" do
    patch occupation_url(@occupation), params: { occupation: { business_type: @occupation.business_type, employer_address: @occupation.employer_address, employer_name: @occupation.employer_name, insured_id: @occupation.insured_id, name: @occupation.name } }
